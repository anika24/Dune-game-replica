...
/**
 * Initialize a body with an alpha constant use to make a polygon body more transparent.
 */
...
/**
 * Initializes a body with an image.
...
/**
 * Returns the image for a given body.
 *
 * @param body the body to check
 * @return the SDL_Surface image for the body
 */
SDL_Surface *body_get_image(body_t *body);

/**
 * Initialize the rec for a given body.
 *
 * @param body the body to add to
 * @param rec the SDL_Rect to add
 */
void body_init_rec(body_t *body, rec_t *rec);

/**
 * Gives a body an image and if it already has one it removes 
 *
 * @param body the body to add to
 * @param image the new image to put for the body
 */
 ...
 *
 * @param body the body to check
 * @return the SDL_Rect rectangle of image for the body
 */
rec_t *body_get_rec(body_t *body);
/**
 * Adds an angle for angle of body image.
 * 
 * @param body the body to check
 * @param add_angle the angle to add to the body angle
 */
void body_add_to_angle(body_t *body, double add_angle);

/**
 * Return the angle fora given body
 * 
 * @param the body to check
 * @return the angle for a given body
 */
double body_get_angle(body_t *body);

/**
 * Return the alpha for a given body
 * 
 * @param the body to check
 * @return the alpha for a given body
 */
...
/**
 * Set the alpha for a given body
 * 
 * @param body to check
 * @param alpha value
 * @return n/a
